...
trait ValidatorDataProviderTrait
{
    ...
    {
        yield ['AD1200012030200359100120', InvalidChecksumException::class];
        yield ['AT611904300234573221', InvalidChecksumException::class];
        yield ['BA39129007940028494', InvalidLengthException::class];
        yield ['BE685390047034', InvalidLengthException::class];
        yield ['VG611904300234573201', InvalidLengthException::class];
        yield ['ST68000200010192194210112', InvalidChecksumException::class];
        yield ['MCBKCWCU25727002', InvalidLengthException::class];
        yield ['QQ99656', UnsupportedCountryCodeException::class];
        yield ['TR33AB06100519786457841326', InvalidFormatException::class];
    }
}
